		...
		<div class="card">
			<div class="card-header">
                                <form action="service_add.php" method="POST">
                                        ...
                                        <input type="submit" class="btn btn-amber" name="del_file" value="Add New Service(service Bahru)">
                                    </form>
                            <form action="service_add2.php" method="POST">
                                        <input type="hidden" name="file_id" value="12">
                                        <input type="submit" class="btn btn-amber" name="del_file" value="Add Service From List">
                                    </form>
				<a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                <?php if(isset($_POST['del_serv_id'])){ $del_serv = getServiceDetailByID($_POST['del_serv_id']); ?>
                                <h1 class="text-danger">ARE YOU SURE WONTO DELETE (<?php echo $del_serv['name']; ?>) From your list
                                ...
                                if(isset($_POST['del_file_yes'])){
                                       delServiceFromPomenList($_POST['del_id'],$pomen['id']);
                                echo 'DELETED';}
                                 ?>
			</div>
			<div class="card-content collapse show">
				<div class="table-responsive">
					<table class="table">
						...
						<tbody>
                                                    <?php $service_list = getServicesByUserID($pomen['id']); 
