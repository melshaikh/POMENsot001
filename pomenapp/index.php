            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title h2-mobile mt-0 is-revealing">POMEN SOT</h1>
                            <p class="hero-paragraph is-revealing">Mobile App for home services and maintenance.</p>
                            <p class="hero-cta is-revealing"><a class="button button-primary button-shadow" href="#">Get served with us...</a></p>
                        </div>
                        ...
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm">Geate Team is here for helping you.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile">INTEGRITY</h4>
                                    <p class="text-sm">Together as one.</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile">OUR VALUES</h4>
                                    <p class="text-sm">We serve...<br>Providing great services for customer...<br>Customer problem is Our tagline...<br>we solve it..</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    <div class="brand footer-brand">
                        <a href="#">
                            <svg width="48" height="32" viewBox="0 0 48 32" xmlns="http://pomen.atwebpages.com/">
                                <title>Pomen</title>
                                <defs>
...
<!--                        <li>
                    ...
                    <div class="footer-copyright">&copy; 2021 POMEN SOT, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
