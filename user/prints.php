    ...
    echo '<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li '.$users.' class=" nav-item"><a href="index.php"><i class="ft-pie-chart"></i><span class="menu-title" data-i18n="">Services</span></a>
          </li>
          <li '.$others.' class=" nav-item"><a href="index.php"><i class="ft-pie-chart"></i><span class="menu-title" data-i18n="">Others</span></a>
          </li>
